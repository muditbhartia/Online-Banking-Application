...
<div id="header">
	<h1>INDIAN BANK<span class="style1"></span></h1>
    <h2>VIT CHENNAI CAMPUS BRANCH</h2>		
</div>
...
<table><%
		...
		if(status==true){
			out.print("Welcome    " + username);
//		    out.println("       TARGET ACCOUNT NO DOES NOT EXSIT -->    " + taccountno);
		 
			Connection con=GetCon.getCon();
			PreparedStatement ps=con.prepareStatement("Select * from NEWACCOUNT where accountno=" +Integer.toString(accountno));
...
//			System.out.print(""+rs.getInt(5));
			...
			PreparedStatement ps1=con1.prepareStatement("update NEWACCOUNT set amount=? where accountno=" +Integer.toString(accountno));
			...
			PreparedStatement ps3=con3.prepareStatement("update NEWACCOUNT set amount=? where accountno=" +Integer.toString(taccountno));
